window.__ModuleLoader__.load({ id: "dsh-llm-newapi-vision", factory: (require) => {
...
function NewApiSection(props) {
  ...
  const [toolImageReview, setToolImageReview] = (0, import_react.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "newapi-catalog", "aria-label": t("models"), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "newapi-proxyrow", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
            checked: toolImageReview,
            "aria-label": t("toolImageReview"),
            onChange: (event) => {
              setToolImageReview(event.target.checked);
            }
          }
        ),
        t("toolImageReview")
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "newapi-hint", children: t("toolImageReviewHint") }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "newapi-modelfield", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                ...
                onChange: (event) => {
                  patch(index, { supportsImageInput: event.target.checked });
                }
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-hint", children: t("modelVisionHint") })
          ] }),
...
function apply(ctx) {
  ctx.effect(() => ctx.locale.register(NS2, { zh, en }), "llm-newapi-vision: copy dictionaries");
  ...
  const fetchModelParams = (request) => connection.rpc.call("/llm-newapi-vision", "models-dev-params", request);
  const injected = () => ({
    fetchModelParams,
    api: {
